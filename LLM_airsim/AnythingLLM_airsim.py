#AnythingLLM_airsim.py
import requests  # 用于调用 AnythingLLM 本地 API
...
# 调用 AnythingLLM 本地 API 的函数
def ask(prompt):
    chat_history.append({"role": "user", "content": prompt})

    url = "http://localhost:3001/api/v1/workspace/test2/chat"
    headers = {
        "Authorization": "Bearer J5DTG0P-4Z3MKA8-M7BSR6N-K7SZFS7",
